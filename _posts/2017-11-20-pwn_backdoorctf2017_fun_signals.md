...
![](/post_pic/2017-11-20-pwn_backdoorctf2017_fun_signals/signal.png)
...
![](/post_pic/2017-11-20-pwn_backdoorctf2017_fun_signals/sigret.jpg)
...
![](/post_pic/2017-11-20-pwn_backdoorctf2017_fun_signals/sigret_aslr.png)

通过设置 `eax/rax` 寄存器，可以利用 `syscall` 指令执行任意的系统调用，然后我们可以将 `sigreturn` 和 其他的系统调用串起来，形成一个链，从而达到任意代码执行的目的。下面是一个伪造 frame 的例子：

![](/post_pic/2017-11-20-pwn_backdoorctf2017_fun_signals/fake_frame.jpg)
...
![](/post_pic/2017-11-20-pwn_backdoorctf2017_fun_signals/attack.png)
